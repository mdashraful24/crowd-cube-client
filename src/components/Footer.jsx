...
const Footer = () => {
    return (
        <div className="pb-2 shadow-inner border-t">
            <footer className="footer container mx-auto grid grid-cols-2 md:grid-cols-3 justify-items-center gap-8 pt-5 pb-2 px-8">
                <nav>
            ...
            <footer className="container mx-auto text-base-content px-8 md:px-10 lg:px-24 flex flex-col-reverse text-center items-center justify-between gap-5">
                <aside className="grid-flow-col items-center">
                    <p className='space-y-0.5'>
                        ...
                        <br />
                        <span>Innovating solutions for the future since 2000.</span>
                        <br />
                        <span>&copy; {new Date().getFullYear()} CrowdCube. All rights reserved.</span>
                    </p>
                </aside>
                    ...
                    <div className="grid grid-flow-col gap-4">
                        <a
                            ...
                            <svg
                                ...
                                height="24"
                                viewBox="0 0 24 24"
                                className="fill-current transition-transform duration-500 ease-in-out hover:text-blue-500 hover:scale-125">
                                <path
                        ...
                        <a href="https://www.instagram.com/" target="_blank">
                            <img className='w-8 h-6 transition-transform duration-500 ease-in-out hover:scale-125' src={instagram} alt="" />
                        </a>
                        <a
                            ...
                            <svg
                                ...
                                height="24"
                                viewBox="0 0 24 24"
                                className="fill-current transition-transform duration-500 ease-in-out hover:text-red-600 hover:scale-125">
                                <path
